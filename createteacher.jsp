	...
	<section class="container-fluid">
		<section class="row  bg">
			<section class="col-12 col-sm-6 col-md-3">
				<form class="form-deep-tech" action="TeacherRegister" method="post">
					<section class="success text-center"><h2>Register Teacher</h2></section>
  					<div class="form-group">
				
					    <input type="text" class="form-control" placeholder="Enter  Name" required="required" id="name" name="name">
					  </div>
					   <div class="form-group">
