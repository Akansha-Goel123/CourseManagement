	...
	<section class="container-fluid">
		<section class="row justify-content-center bg">
			<section class="col-12 col-sm-6 col-md-3">
				<form class="form-container" action="UploadNotes" method="post" enctype="multipart/form-data">
					<section class="header"><h2>Uploading Notes</h2></section>
  					<div class="form-group">
					    <label for="stu_id">Topic Name:</label>
					    <input type="text" class="form-control" placeholder="Enter Topic Name" id="topic" name="topic">
					  </div>
					  <div class="form-group">
